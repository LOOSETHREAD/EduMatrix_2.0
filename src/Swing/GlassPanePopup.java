...
/**
 * GlassPanePopup allows popups to be displayed using a glass pane in a JFrame.
 * Includes functionality for adding, showing, and closing popups.
 */
public class GlassPanePopup {
    ...
    private static PopupCloseListener popupCloseListener;
    ...
    public static void setPopupCloseListener(PopupCloseListener listener) {
        popupCloseListener = listener;
    }
    ...
    public static void closePopup(int index) {
        ...
        if (index >= 0 && index < instance.getLayerPane().getComponentCount()) {
            if (instance.getLayerPane().getComponent(index) instanceof Popup) {
                ...
                // Trigger the listener after closing the popup
