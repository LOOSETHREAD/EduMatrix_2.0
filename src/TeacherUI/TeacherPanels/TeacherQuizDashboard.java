...
import TeacherUI.TeacherBoxes.CourseQuizBox;
import Data.Models.ModelCourse;
import Swing.EventItem;
public class TeacherQuizDashboard extends javax.swing.JPanel {
    public void setEvent(EventItem event) {
        this.event = event;
    }
    public TeacherQuizDashboard() {
        initComponents();
    }
    private EventItem event;
     public void addItem(ModelCourse data) {
        CourseQuizBox quiz = new CourseQuizBox();
        quiz.setData(data);
        quiz.onClick2(event);
        panelItem1.add(quiz);
        refreshPanel();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Select a course for quizes");
