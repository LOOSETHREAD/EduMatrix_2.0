...
public class QuizInfo extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        quizTotal.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                quizTotalKeyPressed(evt);
            }
        });
    ...
    private void quizTotalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_quizTotalKeyPressed
         if (evt.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER) {
        UpdateBtn();
    }
    }//GEN-LAST:event_quizTotalKeyPressed
